...
- [x] Update `src/index.js` passthrough paths (`toHtml`, `toMarkdown`) to throw errors instead of returning input.
- [x] Add tests in `test/unit/markdown.test.js` for raw HTML escaping, risky URL filtering, and text node escaping.
- [x] Add tests in `test/unit/index.test.js` (or similar) to ensure passthrough paths throw.
